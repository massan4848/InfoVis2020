function Isosurfaces( volume, isovalue, camera, light, reflection_model, ka, kd, ks){
    if ( reflection_model === undefined )reflection_model = "CookTrrance";
    ...
    // Color for the specified isovalue
    var point_color = new THREE.Color().setHex( cmap[ isovalue ][1] );
    ...
    var material = new THREE.ShaderMaterial({
        ...
        uniforms: {
            point_color: { type: 'v3', value: point_color },
