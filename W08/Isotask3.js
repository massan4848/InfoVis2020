        ...
        for ( var y = 0; y < vy - 1; y++ ){
            for ( var x = 0; x < vx - 1; x++ ){
                ...
                for ( var j = 0; lut.edgeID[index][j] != -1; j += 3 ){
                    ...
                    var i0 = v0.x + v0.y*vx + v0.z*vy*vx;
                    var i1 = v1.x + v1.y*vx + v1.z*vy*vx;
                    var i2 = v2.x + v2.y*vx + v2.z*vy*vx;
                    var i3 = v3.x + v3.y*vx + v3.z*vy*vx;
                    var i4 = v4.x + v4.y*vx + v4.z*vy*vx;
                    var i5 = v5.x + v5.y*vx + v5.z*vy*vx;
