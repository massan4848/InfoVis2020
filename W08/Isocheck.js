function Isosurfaces( volume, isovalue )
{
    ...
    {
        var i0 = (v0.y*volume.resolution.x)+(v0.z*volume.resolution.x*volume.resolution.y);
        s0 = volume.values[i0][0];        
        var i1 = (v1.y*volume.resolution.x)+(v1.z*volume.resolution.x*volume.resolution.y);
        s1 = volume.values[i1][0];
